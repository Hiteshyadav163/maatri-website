...
<div class="mobile-drawer" id="mobileDrawer">
  <div class="mobile-drawer-inner">
    ...
    <div style="margin-bottom:28px;padding-bottom:20px;border-bottom:1px solid rgba(0,0,0,0.06);">
    ...
    <div class="mobile-drawer-ctas">
      ...
      <a href="https://wa.me/919183216100?text=Hello%20MaatriSparsh%20Team" target="_blank" class="mob-cta-wa">💬 Chat on WhatsApp</a>
    </div>
  </div>
</div>
  ...
  <div class="footer-grid">
    <div>
      ...
      <div class="footer-social">
        <a href="https://www.instagram.com/maatrisparsh?igsh=eXBpejNtc3Uzd2o1" aria-label="Instagram">IG</a>
    ...
    <div class="footer-col">
      ...
      <ul>
        <li><a href="mailto:maatrisparsh@gmail.com">maatrisparsh@gmail.com</a></li>
        <li><a href="https://wa.me/919183216100">+91 9183216100</a></li>
...
<div class="wa-float">
  ...
  <a class="wa-btn" href="https://wa.me/919183216100?text=Hello%20MaatriSparsh%20Team" target="_blank" rel="noopener" aria-label="Chat on WhatsApp">
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // After nav, inject drawer + overlay
  const drawerFrag = document.createElement('div');
  drawerFrag.innerHTML = NAV_HTML;

  // Re-inject drawer separately
  const drawerWrapper = document.createElement('template');
  drawerWrapper.innerHTML = NAV_HTML;
  ...
  const revealObs = new IntersectionObserver((entries) => {
    entries.forEach(entry => {
      if (entry.isIntersecting) {
        ...
        let delay = 0;
        siblings.forEach((s, i) => { if (s === el) delay = i * 80; });
